...
const formSchema = z.object({
        value: z.string().min(1,{message:"Vaue is required"}).max(10000,{message:"Value is too long"}),
    })
...
export const MessageForm = ({projectId}:MessageFormProps)=>{
    ...
    const createMessage = useMutation(trpc.messages.create.mutationOptions({
        ...
        onError:(error)=>{
            //Redirect to pricing page is specific error
    ...
    return(
            ...
            <div className="flex gap-x-2 items-end justify-between pt-2">
                <div className="text-[10px] text-muted-foreground font-mono">
                    <kbd className="ml-auto pointer-event-none inline-flex h-5 select-none 
                    items-center gap-1 rouneded border bg-muted px-1.5 font-mono text-[10px] 
