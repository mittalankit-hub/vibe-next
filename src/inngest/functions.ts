...
`,
    ...
    createTool({
      ...
      lifecycle:{
        ...
        const localAssistantTextMessage = localAssistantTextMessageContent(result)
        if(localAssistantTextMessage && network){
            if(localAssistantTextMessage.includes("<task_summary>")){
                network.state.data.summary = localAssistantTextMessage
            }
        }
        return result;
        }},
